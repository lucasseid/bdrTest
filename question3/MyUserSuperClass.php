 ...
 * DatabaseConnection, porem para fins do teste, e ja que nada do real trabalho
 * da aplicação está sendo realizado, tais variaveis serão mantidas no objeto de
 * Super Classe 
*/
